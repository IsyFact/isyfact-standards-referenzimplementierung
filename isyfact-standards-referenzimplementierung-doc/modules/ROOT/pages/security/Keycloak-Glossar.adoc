...
+
Attribute des Nutzers (zum Beispiel Name, zugeordnete Rechte, …) und Autorisierungsinformationen aus bzw. von KeyCloak.
...
Maßgeblich sind folgedende Abschnitte der IsyFact Standards - Bausteine - Security - Nutzungsvorgaben: +
